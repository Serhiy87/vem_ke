...
enum {
	...
	GSM_WAIT_RDY,//2
	GSM_SEND_CGMM,//3
 	GSM_WAIT_CGMM_READ,//4
	GSM_WAIT_CFUN,//5
	GSM_WAIT_CPIN_READY,//6
	GSM_WAIT_CALL_READY,//7
	GSM_WAIT_SMS_READY,//8

	GSM_SEND_E0, 		GSM_WAIT_E0_OK,//9,10

	GSM_SEND_CMGF,		GSM_WAIT_CMGF_OK,//11,12
	GSM_SEND_CSMP,		GSM_WAIT_CSMP_OK,//13,14
	GSM_SEND_CIPMUX, 	GSM_WAIT_CIPMUX_OK,//15,16
	GSM_SEND_CIPMODE, 	GSM_WAIT_CIPMODE_OK,//17,18

	GSM_WAIT_1,//19

	GSM_SEND_CGATT,		GSM_WAIT_CGATT_OK,//20,21
	GSM_SEND_CIPCSGP,	GSM_WAIT_CIPCSGP_OK,//22,23
		GSM_SEND_CIPTKA,	GSM_WAIT_CIPTKA_OK,//24,25
	GSM_SEND_CSTT,		GSM_WAIT_CSTT_OK,//26,27
	GSM_SEND_CIICR,		GSM_WAIT_CIICR_OK,//28,29

	GSM_SEND_CIFSR,		GSM_WAIT_CIFSR_OK,//30,31
...
volatile uint8_t GPRS_FlgSz_Out, GPRS_FlgSz_In, SMS_FlgSz_Out;
