...
// ~~~~~~~~~~~
//FIFO
#define EM_RX_FIFO_SIZE 70		// при условиях до 5мс ScanCycle и GPRS_In_MaxSz =< 50
uint8_t EM_RX_FIFO[EM_RX_FIFO_SIZE];
volatile uint8_t EM_RX_FIFO_Begin;	//Индекс последнего принятого байта
uint8_t EM_RX_FIFO_End;	//Индекс последнего прочитаного байта
...
/*
//	if(GSM_State == GSM_DataMode){	// в прозрачном режиме что получили то и отдаём на модем
//		UDR_GSM = UDR_EMETER;
//	}
//	else{
...
/*//	if(GSM_State == GSM_DataMode){	// в прозрачном режиме
	//TODO
//	}
//	else{
